...
<!-- 일정 등록 부분 -->
	<div class="event">
		<p>
			선택 날짜 : <span class="calT"></span>
			일정 입력 : <input type="text" name="eventT" class="eventT">
			<button class="eventBtn">추가</button>
		</p>
			<!-- 일정 -->
...
$(function(){
    ...
    $('.eventBtn').click(function(){
		var et = $('.eventT').val();
		console.log(et); /* 사용자가 입력하는 값 */
		console.log(date); /* 사용자가 선택한 날짜 */
