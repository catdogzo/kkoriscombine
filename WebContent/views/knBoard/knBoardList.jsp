...
<style>
	...
	#writeBtn{position: absolute; bottom: 100px; right: 10%; font-size: 15px; border-radius: 5px; width: 80px; height: 35px; font-size: 14px; font-weight: 600; text-align: center; border: none; border-radius: 5px; background: #aedefc; color: #5d5d5d;}
	...
	.searchArea{margin: 20px auto; text-align: center;}
	...
	#searchForm {position: absolute; bottom: 20px; width: 80%;}
			...
			i(document).ready(function() {
		        $.contextMenu({
		            ...
		            callback: function(key, options) {
						...
						location.href='<%= request.getContextPath() %>/views/message/messageSendView.jsp?id=' + usId;
		            },
		            items: {
		                "쪽지보내기": {name: "쪽지보내기"}
		            }
