...
<style>
	...
	#kncon{align: auto; width: 100%; max-height: 680px; padding: 10px; overflow: auto;}
					...
					<table id="tableD">
						...
						<tr>
							<td class="aleft" width="50%">글쓴이&nbsp;&nbsp;
								<span style="font-size:15px; font-weight: 300"><input type="hidden" name="usId" value="<%= kn.getUsId()%>"><%= kn.getUsNick() %></span>
							</td>
							<td class="aleft">날짜&nbsp;&nbsp;
						...
						<% } else if(loginAu != null && loginAu.getAuKind().equals("ADMIN")){ %>
							<input type="submit" id="updateBtn" value="수정">
							<input type="button" onclick="location.href='javascript:history.back();'" id="listBtn" value="목록으로" style= "margin-left: 400px; margin-top: 30px;">
						<% }else{ %>
							<input type="button" onclick="location.href='javascript:history.back();'" id="listBtn" value="목록으로" style= "margin-left: 400px; margin-top: 30px;">
						<% } %>
							</td>
